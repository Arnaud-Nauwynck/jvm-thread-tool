...
@Slf4j
public class VirtualMachineFlameGraphProvider {
	...
	public VirtualMachineFlameGraphProvider(int pid, ScheduledExecutorService scheduledExecutor) {
		this.pid = pid;
	...
	public void init() {
    	...
    	acc = new FlameGraphAccumulator(new HotspotVirtualMachineThreadDumpProvider(vm));
	}
